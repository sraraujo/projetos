...
function time(){
    ...
    var hora = agora.getHours() > 9 ? agora.getHours() : `0${agora.getHours()}`
    var minutos = agora.getMinutes() > 9 ? agora.getMinutes() : `0${agora.getMinutes()}`
    var segundps = agora.getSeconds() > 9 ? agora.getSeconds() : `0${agora.getSeconds()}`
    ...
    // bloco de código para pegar o DIA
    switch (agora.getDay()) {
        case 0:
            diaSemana = "Domingo"
            break;
    ...
    // bloco de código para pegar o MÊS
